...
| `PING_TIMEOUT_MS` | `1000` | Próg (ms) — ping wolniejszy niż próg liczony jest jako timeout/awaria |
| `CONNECT_TIMEOUT_SECONDS` | `1` | Wartość domyślna dla `PING_TIMEOUT_MS`, gdy ten nie jest ustawiony (legacy) |
